...
const AdminReports = () => {
  ...
  }, [reportType, filters.month, filters.year, filters.class]);

  const fetchStudents = async () => {
    try {
      const { data } = await studentAPI.getAll({ limit: 1000 });
      ...
      <div className="reports-container">
        ...
        <div className="reports-header">
          <div>
            ...
            <p className="reports-subtitle">View and export attendance reports</p>
          </div>
        ...
        <div className="filters-card">
          ...
          {reportType === 'monthly' ? (
            <div className="filters-grid">
              ...
              <div className="filter-group">
                <label className="filter-label">Class (Optional)</label>
                <input
                  type="text"
                  name="class"
                      ...
                      <tbody>
                        {studentAttendance.attendance.map((record) => (
                          <tr key={record._id}>
                            ...
                            <td>
                              <span className="table-teacher">{record.teacher?.name || 'N/A'}</span>
                            </td>
                            <td>
